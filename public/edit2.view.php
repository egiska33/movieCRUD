<form  action="update.php?id=<?php echo $result['id'] ?>" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <button  type="submit" value="submit" class="btn btn-success">redagavimas</button>
